...
class UniSystem(Tk.Frame):
    ...
    def fill_table(self):
        ...
        for r in xrange(rows):
            ...
            row_info = self.candidates[r-1].get_info_list(class_choice)
